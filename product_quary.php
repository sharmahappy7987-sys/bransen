...
<div class="container">
    <p>Hi,</p>
    <div class="thankyou">
        <h3>You have Customer product Detail </h3>
    </div>
    <br>
    <table class="table table-hover data-cart">
        ...
        <tr>
            <th>Product Name :-</th>
            <th>'.$_POST["showProduct"].'</th>
        </tr>
        <tr>
            <th>Product Price :-</th>
            <th>'.$_POST["showPrice"].'</th>
        </tr>
        <tr>
            <th>Name :-</th>
            <th>'.$_POST["user"].'</th>
        ...
        <tr>
            <th>Email :-</th>
            <th>'.$_POST["con_email"].'</th>
        </tr>
        <tr>
            <th>Phone :-</th>
            <th>'.$_POST["con_phone"].'</th>
        </tr>
        <tr>
            <th>Pin :-</th>
            <th>'.$_POST["con_pin"].'</th>
        ...
        <tr>
            <th>City :-</th>
            <th>'.$_POST["con_city"].'</th>
        </tr>
        <tr>
            <th>Address :-</th>
            <th>'.$_POST["con_address"].'</th>
        </tr>
        </thead>
    </table>
    <div class="signature">
