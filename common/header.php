<?php
$email="Info@bransenpharma.com";
$phone="+91-8958132172";
$address="Tirupati Dham Colony, Kargana, Near Kargaina Police Chawki, Badaun Road, Bareilly,
Uttar Pradesh, 243001";
$address2="3rd Floor Joga Bai Extn., Okhla Jamia Nagar, New Delhi-110025"
?>
<!doctype html>
    ...
    <title>Medito – Health & Medical HTML5 Template </title>
    ...
    <link rel="stylesheet" href="assets/css/flaticon_medical.css">
    ...
    <div class="it-offcanvas-area">
        <div class="itoffcanvas">
            ...
            <div class="itoffcanvas__logo">
                <a href="index.html">
                <img src="assets/img/logo/logo.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                </a>
            </div>
            ...
            <div class="itoffcanvas__info">
                ...
                <div class="itoffcanvas__info-address">
                    <span>Email</span>
                    <a href="maito:<?php echo "$email"?>"><?php echo "$email"?></a>
                </div>
                </div>
                <div class="it-info-wrapper mb-20 d-flex align-items-center">
                <div class="itoffcanvas__info-icon">
                ...
                <div class="itoffcanvas__info-address">
                    <span>Location</span>
                    <a href="<?php echo "$address"?>" target="_blank"><?php echo "$address"?></a>
                </div>
                </div>
            </div>
        </div>
    ...
    <!-- modal-area-start -->
    <div class="modal fade it-product-modal" id="producQuickViewModal" tabindex="-1" aria-labelledby="producQuickViewModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="it-product-modal-content d-lg-flex align-items-start">
                <button type="button" class="it-product-modal-close-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal"><i class="fa-regular fa-xmark"></i></button>
                <div class="it-product-details-thumb-wrapper it-tab d-sm-flex">
                    <nav>
                        <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                            ...
                            <img src="assets/img/shop/pro-sm-1-1.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                            </button>
                            ...
                            <img src="assets/img/shop/pro-sm-1-2.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                            </button>
                            ...
                            <img src="assets/img/shop/pro-sm-1-3.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                            </button>
                            ...
                            <img src="assets/img/shop/pro-sm-1-4.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                            </button>
                        </div>
                    </nav>
                    <div class="tab-content m-img" id="productDetailsNavContent">
                        <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                            <div class="it-product-details-nav-main-thumb">
                            <img src="assets/img/shop/pro-1-1.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                            </div>
                        </div>
                        <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                            <div class="it-product-details-nav-main-thumb">
                            <img src="assets/img/shop/pro-1-2.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                            </div>
                        </div>
                        <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                            <div class="it-product-details-nav-main-thumb">
                            <img src="assets/img/shop/pro-1-3.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                            </div>
                        </div>
                        <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                            <div class="it-product-details-nav-main-thumb">
                            <img src="assets/img/shop/pro-1-4.png" alt="Bransen Pharmaceuticals Pvt Ltd">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="it-product-details-wrapper">
                    <div class="it-product-details-category">
                        <span> Hospital Equipment</span>
                    </div>
                    <h3 class="it-product-details-title">Optical Microscope</h3>

                    <!-- inventory details -->
                    <div class="it-product-details-inventory d-flex align-items-center mb-10">
                        <div class="it-product-details-stock mb-10">
                            <span>In Stock</span>
                        </div>
                        <div class="it-product-details-rating-wrapper d-flex align-items-center mb-10">
                            <div class="it-product-details-rating">
                            ...
                            <div class="it-product-details-reviews">
                    ...
                    <!-- price -->
                    <div class="it-product-details-price-wrapper mb-20">
                        <span class="it-product-details-price old-price">$255.00</span>
                        <span class="it-product-details-price new-price">$199.00</span>
                    </div>

                    <!-- actions -->
                    <div class="it-product-details-action-wrapper">
                        <h3 class="it-product-details-action-title">Quantity</h3>
                        <div class="it-product-details-action-item-wrapper d-flex align-items-center">
                            ...
                            <div class="it-shop-details__btn mb-15 w-100">
                            <a class="it-btn-theme w-100 d-flex justify-content-center" href="cart.html">
                                <span class="btn-wrap">
                                    <span class="text-one">
                                        Add To Cart
                                    </span>
                        ...
                        <button class="it-btn-theme black-bg w-100 d-flex justify-content-center">
                            <span class="btn-wrap">
                            <span class="text-one">
                                Buy Now
                            </span>
                    ...
                    <div class="it-product-details-action-sm">
                        <button type="button" class="it-product-details-action-sm-btn">
    ...
    <header>
        ...
        <div class="it-header-top-area it-header-top-style-3">
            <div class="container">
                <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="it-header-top__left d-flex align-items-center">
                        <div class="it-header-top__category-wrap d-none d-md-block">
                            <div class="it-header-top__category" id="it-header-top__category-toogle">
                            <ul>
                                <li>
                                    <p class="m-0"><i class="fa-regular fa-envelope fa-lg"></i> <?php echo "$email"?></p>
                                </li>
                            </ul>
                            </div>
                        </div>
                        <div class="it-header-top__area-wrap d-none d-md-block">
                            <div class="it-header-top__area" id="it-header-top__area-toogle">
                            <ul>
                                <li>
                                    <p  class="m-0"><i class="fa-solid fa-mobile-screen fa-lg"></i> <?php echo "$phone"?></p>
                                </li>
                            </ul>
                            </div>
                        </div>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 d-none d-lg-block wow itfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                    <div class="text-end">
                        <a class="mr-5 hover" href="https://www.facebook.com/share/18ThMFu4MG/"><i class="fa-brands fa-facebook-f"></i></a>
                        <a class="mr-5 hover" href="#"><i class="fa-brands fa-x-twitter"></i></a>
                        <a class="mr-5 hover" href="#"><i class="fa-brands fa-instagram"></i></a>
                        <a class="mr-5 hover" href="#"><i class="fa-brands fa-youtube"></i></a>
                    </div>
                </div>
                </div>
            </div>
        ...
        <style>
            .text-end .hover:hover{
                color:#7E57CD;
            }
        </style>

        <!-- header-area-start -->
        <div id="header-sticky" class="it-header-area it-header-ptb it-header-style-2 it-header-style-3 it-header-style-5 white-bg">
            <div class="container">
                <div class="p-relative">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-2 col-6 col-sm-3">
                        <div class="it-header-logo">
                            <a href="index.php  "><img src="assets/img/logo/logo2.png" alt="Bransen Pharmaceuticals Pvt Ltd" class="col-6"></a>
                        </div>
                    </div>
                    <div class="col-xl-7 col-md-6 d-none d-md-none d-xl-block">
                    ...
                    <div class="col-xl-3 col-6 col-sm-9 d-lg-block d-xl-none">
                        <div class="it-header-bar d-xl-none text-end">
                            <button class="it-menu-bar">
                                <span class="align-content-center"><i class="fa-solid fa-bars-staggered"></i></span>
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div id="popupForm" class="popup ">
        <div class="popup-content" >
            ...
            <h4>Place Order</h4>           
            <form id="orderForm" class="product_form" action="#" method="post">
                <div class="d-flex gap-3">

                    <div class="col-2 border"><img  id="showImg" ></div>

                    <div class="gap-2 " style="justify-items: flex-start; align-content: center;">
                        <p class="m-0"><strong>Product:</strong> <span id="showProduct1"></span></p>
                        <p class="m-0"><strong>Price:</strong>  ₹<span id="showPrice1"></span></p>
                    </div>
                </div>
                ...
                <div class="d-flex gap-2">
                    <div class="col-6 text-start" >
                        ...
                        <span id="userconname" class="error text-danger"></span>
                    </div>
                    <div class="col-6 text-start">
                        <input type="text" name="con_phone" id="con_phone" placeholder="Mobile Number" >
                        <span id="userconphone" class="error text-danger"></span>
                    </div>
                </div>
                    <div class="col-12 text-start" >
                        <input type="email" name="con_email" id="con_email" placeholder="email" >
                        <span id="userconemail" class="error text-danger"></span>
                    </div>
                <div class="d-flex gap-2">
                    <div class="col-6 text-start">
                        <input type="text" id="con_city" name="con_city" placeholder="Your City" >
                        <span id="userconcity" class="error text-danger"></span>
                    </div>
                    <div class="col-6 text-start">
                        <input type="text" name="con_pin" id="con_pin" placeholder=" Enter Pin" >
                        <span id="userconpin" class="error text-danger"></span>
                    </div>
                </div>

                <input  type="text" name="con_address" id="con_address"  placeholder="Address" >

                <!-- Hidden Product -->
                <input type="hidden" id="productImg">
                <input type="hidden" id="productName">
                <input type="hidden" id="productPrice">
                <button class="butn" type="submit" id="submit1" name="contact1">Submit</button>
            </form>
        </div>
    </div>
    <!-- product form poppu -->
